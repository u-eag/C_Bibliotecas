...
int main()
{
    ...
    int botonPrestamos=0; // para dar la opcion de alta o de informar/listar
    ...
    do{
        ...
        {
            case 'A': // Alta
                if(altaSocios(arraySocios, TAM_SOC)==0)
                {
                    flagBotonAlta=1;
                }
                system("pause");
            ...
            case 'G': // 1. Alta prestamo 2. Informar y Listar
                if(flagBotonAlta)
                {
                    do{
                        system("cls");

                        printf("*** MENU PRESTAMOS - BIBLIOTECA ***\n\n");
                        printf("1. Alta\n");
                        printf("2. Informar y Listar\n");
                        printf("3. Volver al menu principal\n\n");

                        getInt(&botonPrestamos, "Seleccione una opcion del menu: ", "\nOpcion no valida\n\n", 1, 3, 1);

                        switch(botonPrestamos)
                        {
                            case 1: // Alta
                            ...
                            case 2: // Informar y listar

                                system("pause");
                                break;
                        }
                    }while(botonPrestamos!=3);
                }
                else
                {
